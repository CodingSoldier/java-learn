...
import com.cpq.validatetest.bean.Dream;
import com.cpq.validatetest.bean.Girl;
import com.cpq.validatetest.bean.UserVo;
import com.cpq.validatetest.bean2.ResultCheckVo;
...
public class Test01 {
    ...
    public void testVo11() throws Exception{
        String filePath = "/validate/test.json";
