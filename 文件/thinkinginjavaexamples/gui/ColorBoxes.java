package com.thinkinginjavaexamples.gui;//: gui/ColorBoxes.java
// A visual demonstration of threading.
import com.thinkinginjavaexamples.generics.Dimension;
...
class CBox extends JPanel implements Runnable {
  ...
  public void paintComponent(Graphics g) {
    g.setColor(color);
    com.thinkinginjavaexamples.generics.Dimension s = getSize();
