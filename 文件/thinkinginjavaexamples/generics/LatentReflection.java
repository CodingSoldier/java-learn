package com.thinkinginjavaexamples.generics;//: generics/LatentReflection.java
...
public class LatentReflection {
  public static void main(String[] args) {
    ...
    CommunicateReflectively.perform(new com.thinkinginjavaexamples.concurrency.Robot());
