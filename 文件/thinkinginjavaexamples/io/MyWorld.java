package com.thinkinginjavaexamples.io;//: io/MyWorld.java
import com.thinkinginjavaexamples.gui.List;

import java.io.*;
import java.util.*;
import static com.thinkinginjavaexamples.net.mindview.util.Print.*;
...
public class MyWorld {
  ...
  throws IOException, ClassNotFoundException {
    ...
    com.thinkinginjavaexamples.gui.List<Animal> animals = new ArrayList<Animal>();
    ...
    com.thinkinginjavaexamples.gui.List
      animals1 = (com.thinkinginjavaexamples.gui.List)in1.readObject(),
      animals2 = (com.thinkinginjavaexamples.gui.List)in1.readObject(),
