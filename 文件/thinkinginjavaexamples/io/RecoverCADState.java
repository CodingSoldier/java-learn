package com.thinkinginjavaexamples.io;//: io/RecoverCADState.java
...
public class RecoverCADState {
  ...
  public static void main(String[] args) throws Exception {
    ...
    com.thinkinginjavaexamples.gui.List<Class<? extends Shape>> shapeTypes =
      (com.thinkinginjavaexamples.gui.List<Class<? extends Shape>>)in.readObject();
    Line.deserializeStaticState(in);
    com.thinkinginjavaexamples.gui.List<Shape> shapes = (List<Shape>)in.readObject();
