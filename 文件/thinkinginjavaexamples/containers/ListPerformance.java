package com.thinkinginjavaexamples.containers;//: containers/ListPerformance.java
// Demonstrates performance differences in Lists.
// {Args: 100 500} Small to keep build testing short
import java.util.*;

import com.thinkinginjavaexamples.concurrency.Tester;
...
public class ListPerformance {
  ...
  static class ListTester extends com.thinkinginjavaexamples.concurrency.Tester<List<Integer>> {
  ...
  public static void main(String[] args) {
    if(args.length > 0)
      com.thinkinginjavaexamples.concurrency.Tester.defaultParams = TestParam.array(args);
    // Can only do these two tests on an array:
    com.thinkinginjavaexamples.concurrency.Tester<List<Integer>> arrayTest =
      new com.thinkinginjavaexamples.concurrency.Tester<List<Integer>>(null, tests.subList(1, 3)){
    ...
    arrayTest.timedTest();
    com.thinkinginjavaexamples.concurrency.Tester.defaultParams= TestParam.array(
    ...
    com.thinkinginjavaexamples.concurrency.Tester.fieldWidth = 12;
    com.thinkinginjavaexamples.concurrency.Tester<LinkedList<Integer>> qTest =
