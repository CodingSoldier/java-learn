...
public class A_Stream {
    ...
    public void w() throws Exception{
        ...
        FileOutputStream fos = new FileOutputStream("E:\\workspace\\java-learn\\web-whole\\src\\main\\java\\ssm\\projectnote\\commonsjar\\io\\b_file_w01.txt");
    ...
    public void rw() throws Exception{
        FileInputStream fis = new FileInputStream("E:\\workspace\\java-learn\\web-whole\\src\\main\\java\\ssm\\projectnote\\commonsjar\\io\\b_file-img-r01.png");
        int size = fis.available();
        byte[] array = new byte[size];
        fis.read(array); //将字节流读取到内存字节数组中，array元素全是8为二进制组成的数字

        FileOutputStream fos = new FileOutputStream("E:\\workspace\\java-learn\\web-whole\\src\\main\\java\\ssm\\projectnote\\commonsjar\\io\\b_file-img-r01-copy.png");
