...
@AllArgsConstructor
@NoArgsConstructor
@TableName("thing_dimension")
@ApiModel(value = "ThingDimensionEntity对象", description = "物模型3维度类型，1（properties），2（event），3（action）")
public class ThingDimensionEntity implements Serializable {
