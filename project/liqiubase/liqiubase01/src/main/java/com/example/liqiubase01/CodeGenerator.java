...
public class CodeGenerator {
    ...
    static final String TABLE_NAME = "test01";
    static final String MODULE_NAME = "test01";
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/project/liqiubase/liqiubase01"; //项目目录
        ...
        dsc.setUrl("jdbc:mysql://10.122.105.117:3307/test_db?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.example.liqiubase01");
