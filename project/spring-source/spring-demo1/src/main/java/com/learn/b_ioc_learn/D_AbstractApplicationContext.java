...
// */
//public abstract class D_AbstractApplicationContext extends DefaultResourceLoader
...
//	 */
//	public D_AbstractApplicationContext() {
...
//	 */
//	public D_AbstractApplicationContext(@Nullable ApplicationContext parent) {
//		this();
//		setParent(parent);
//	}
//
...
//	 * @see D_AbstractApplicationContext#createEnvironment
//	 */
//	@Override
...
//		// 通过父上下文发布事件…
//		if (this.parent != null) {
//			if (this.parent instanceof D_AbstractApplicationContext) {
//				((D_AbstractApplicationContext) this.parent).publishEvent(event, eventType);
//			}
//			else {
...
//		return (getParent() instanceof D_AbstractApplicationContext ?
//				((D_AbstractApplicationContext) getParent()).messageSource : getParent());
//	}
//
//
//	//---------------------------------------------------------------------
