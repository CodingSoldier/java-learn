...
//public class G3_DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
...
//					ClassUtils.forName("javax.inject.Provider", G3_DefaultListableBeanFactory.class.getClassLoader());
//		}
...
//	private static final Map<String, Reference<G3_DefaultListableBeanFactory>> serializableFactories =
...
//	 */
//	public G3_DefaultListableBeanFactory() {
//		super();
//	}
//
//	/**
...
//	 */
//	public G3_DefaultListableBeanFactory(@Nullable BeanFactory parentBeanFactory) {
...
//					((BeanFactoryAware) autowireCandidateResolver).setBeanFactory(G3_DefaultListableBeanFactory.this);
//					return null;
...
//		if (otherFactory instanceof G3_DefaultListableBeanFactory) {
//			G3_DefaultListableBeanFactory otherListableFactory = (G3_DefaultListableBeanFactory) otherFactory;
...
//		if (parent instanceof G3_DefaultListableBeanFactory) {
//			return ((G3_DefaultListableBeanFactory) parent).resolveBean(requiredType, args, nonUniqueAsNull);
//		}
//		else if (parent != null) {
...
//			return ((G3_DefaultListableBeanFactory) parent).isAutowireCandidate(beanName, descriptor, resolver);
//		}
...
//		}
//		BeanFactory parent = getParentBeanFactory();
//		return (parent instanceof G3_DefaultListableBeanFactory &&
//				((G3_DefaultListableBeanFactory) parent).isPrimary(transformedBeanName, beanInstance));
//	}
//
//	/**
...
//		BeanFactory parent = getParentBeanFactory();
//		if (parent instanceof G3_DefaultListableBeanFactory) {
//			((G3_DefaultListableBeanFactory) parent).checkBeanNotOfRequiredType(type, descriptor);
//		}
//	}
//
//	/**
...
//			G3_DefaultListableBeanFactory dummyFactory = new G3_DefaultListableBeanFactory();
